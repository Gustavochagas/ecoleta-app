...
const Home = () => {
    ...
    return (
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ImageBackground source={require('../../assets/home-background.png')} imageStyle={{ width: 247, height: 368 }} style={styles.container}>
          ...
          <View style={styles.footer}>
            <TextInput style={styles.input} placeholder="Digite a UF" value={uf} max-maxLength={2} autoCapitalize={"characters"} autoCorrect={false} onChangeText={setUf} />
